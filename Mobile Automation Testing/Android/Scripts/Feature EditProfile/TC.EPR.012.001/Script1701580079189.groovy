...
Mobile.tap(findTestObject('Feature EditProfile/iconEditNama'), 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditNama'), '', 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditNama'), 'Seller1', 2)
