...
Mobile.tap(findTestObject('Feature EditProfile/iconEditEmail'), 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditEmail'), '', 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditEmail'), 'kel3seller1@gmail.com', 2)

Mobile.tap(findTestObject('Feature EditProfile/ctaSimpan'), 2)

Mobile.verifyElementVisible(findTestObject('Feature EditProfile/verifyProfilBerhasilDiperbarui'), 2)
