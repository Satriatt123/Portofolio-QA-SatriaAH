...
Mobile.tap(findTestObject('Feature EditProfile/iconEditNomorHP'), 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditNomorHP'), '', 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditNomorHP'), '081234567890', 2)
