...
Mobile.tap(findTestObject('Feature EditProfile/iconEditKota'), 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditKota'), '', 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditKota'), 'Bandung', 2)
