...
Mobile.tap(findTestObject('Feature EditProfile/iconEditAlamat'), 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditAlamat'), '', 2)

Mobile.setText(findTestObject('Feature EditProfile/fieldEditAlamat'), 'Jalan duren baru', 2)
