...
while (Mobile.verifyElementNotVisible(findTestObject('Object Repository/Feature ListProductCard/ctaCategory7TasPria'), 1, 
    FailureHandling.OPTIONAL)) {
    Mobile.swipe(535, y, 47, y)
}

Mobile.tap(findTestObject('Feature ListProductCard/ctaCategory7TasPria'), 2)
